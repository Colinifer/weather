...
theme_cw_dark <-  theme(
  ...
  text = element_text(family = "Helvetica", color = color_cw[5]),
  ...
  axis.title = element_text(family = "Helvetica", face = "bold", size = 8),
...
theme_cw_light <-  theme(
  ...
  text = element_text(family = "Helvetica", color = color_cw[1]),
  ...
  axis.ticks.length = unit(2.75, 'pt'),
  axis.title = element_text(family = "Helvetica", face = "bold", size = 8, color = color_cw[3]),
  axis.title.y = element_text(angle = 90, vjust = 0.5),
  ...
  strip.text = element_text(size = 6, color = color_cw[3], family = "Helvetica"),
  legend.position = 'bottom',
  panel.spacing.y = unit(0, 'lines'),
  panel.spacing.x = unit(0.1, 'lines')
)
